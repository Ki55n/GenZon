    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_number', models.CharField(blank=True, error_messages={'unique': 'This contact number is already in use.'}, max_length=20, null=True, validators=[user.utils.validate_contact_number], verbose_name='contact number')),
